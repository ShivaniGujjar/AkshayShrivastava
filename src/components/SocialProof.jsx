...
export default function SocialProof({ brands = DEFAULT_BRANDS, testimonials = DEFAULT_TESTIMONIALS }) {
  return (
    <section className="w-full relative overflow-hidden pt-4 pb-6 sm:pt-8 sm:pb-10 select-none bg-[#FFFCFB]" style={{ fontFamily: "'HelveticaNeue', 'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
          ...
          <div className="animate-marquee-slow-left gap-3 sm:gap-8 w-max">
            {duplicateList(brands).map((brand, idx) => (
              <div 
                ...
                className="px-4 py-1.5 sm:px-5 sm:py-2.5 bg-[#FFFCFB] text-[#14120e] rounded-[8px] inline-flex items-center justify-center shrink-0 shadow-sm text-[11px] sm:text-sm border border-[#144BFF]/20 backdrop-blur-md"
              >
                <span className="text-[#FFC822] mr-1.5 sm:mr-2">•</span>
                {brand}
              </div>
            ))}
          </div>
      ...
      <div className="w-full bg-[#144BFF] relative pt-8 pb-10 sm:pt-20 sm:pb-24 flex flex-col items-center overflow-hidden">
        
        {/* Top Seamless Torn Edge Mask */}
        <div 
          className="absolute top-0 left-0 w-full h-[20px] sm:h-[60px] z-[12] bg-[#FFFCFB]"
          style={{
        ...
        {/* Header */}
        <div className="relative z-[15] text-center mb-4 sm:mb-6 px-4 pt-1">
          <h2 
            style={{ fontFamily: "'Talina', sans-serif", letterSpacing: '0.4px', fontWeight: 400 }}
            className="text-xl sm:text-4xl m-0 text-[#FFFFFF] leading-tight drop-shadow-md"
          >
            Testimonial
          </h2>
          <p 
            style={{ fontFamily: "'HelveticaNeue', sans-serif", letterSpacing: '0.3px', fontWeight: 600 }} 
            className="text-[#FFFFFF]/95 text-[11px] sm:text-sm mt-0.5 sm:mt-1"
          >
        ...
        <div className="w-full overflow-hidden py-1 sm:py-2 relative z-[15]">
          <div className="animate-marquee-slow-right gap-4 sm:gap-7 w-max">
            {duplicateList(testimonials).map((testi, idx) => (
              <div 
                key={`testi-${idx}`} 
                className="relative bg-[#FFFCFB] text-[#14120e] w-[240px] sm:w-[370px] p-3.5 sm:p-7 rounded-[8px] inline-flex flex-col justify-between shrink-0 shadow-lg whitespace-normal border border-white/20 backdrop-blur-xl"
              >
                {/* Decorative Quote Mark */}
                <span className="text-[#144BFF]/20 font-serif text-3xl sm:text-5xl leading-none absolute top-2 right-4 select-none pointer-events-none">
                  “
                </span>
                ...
                <div className="mt-2.5 sm:mt-3 pt-2 sm:pt-2.5 border-t border-black/10 flex items-center justify-between">
                  <div>
                    <p 
                      style={{ fontFamily: "'Talina', sans-serif", letterSpacing: '0.4px', fontWeight: 400 }} 
        ...
        <div 
          className="absolute -bottom-[2px] left-0 w-full h-[20px] sm:h-[65px] z-[12] bg-[#FFFCFB]"
          style={{
            maskImage: "url('/bottom.png')",
            WebkitMaskImage: "url('/bottom.png')",
            maskSize: "auto 100%",
