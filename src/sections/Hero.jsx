  ...
  return (
    <section className="w-full h-screen bg-[#08080a] overflow-hidden relative m-0 p-0 select-none">
      ...
      <header className="fixed top-3 left-0 w-screen max-w-full box-border z-[9999] px-4 sm:px-8 md:px-12 pointer-events-none transition-all duration-400 ease-out flex items-center justify-between">
        ...
        {/* CENTER: CAPSULE NAVIGATION (Desktop Only) */}
        ...
        <div className="pointer-events-auto">
          <a
            ...
            className="font-gourmet bg-[#0A0B0C] text-[#FFFFFF] hover:text-[#FFC822] border border-white/20 px-3 sm:px-5 pt-2 sm:pt-3 pb-1.5 sm:pb-2.5 rounded-xl text-xs sm:text-base flex items-center gap-1.5 transition-all duration-300 shadow-xl cursor-pointer hover:scale-105 no-underline"
          >
      ...
      {/* ================= DESKTOP LAYOUT (EXACTLY UNTOUCHED) ================= */}
      ...
      {/* ================= MOBILE STACKED LAYOUT (USING ACTUAL home-mask-mobile.svg) ================= */}
